...
func expectedSiteTaskContracts() []siteTaskContract {
	return []siteTaskContract{
		...
		{constant.TaskTypePerformanceSync, "durable", "operational_interval", "siteTasks.purpose.performanceSync"},
		{constant.TaskTypeTopupSync, "durable", "operational_interval", "siteTasks.purpose.topupSync"},
		{constant.TaskTypeRedemptionSync, "durable", "operational_interval", "siteTasks.purpose.redemptionSync"},
		{constant.TaskTypeUpstreamTaskSync, "durable", "operational_interval", "siteTasks.purpose.upstreamTaskSync"},
		{constant.TaskTypeModelMetaSync, "durable", "catalog_interval", "siteTasks.purpose.modelMetaSync"},
		{constant.TaskTypePlanSync, "durable", "catalog_interval", "siteTasks.purpose.planSync"},
		{constant.TaskTypePricingSync, "durable", "catalog_interval", "siteTasks.purpose.pricingGroupSync"},
		{constant.TaskTypeSystemTaskSync, "durable", "catalog_interval", "siteTasks.purpose.systemTaskSync"},
