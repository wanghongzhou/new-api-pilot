...
func writeValidA25Run(t *testing.T) string {
	...
	report.InitializedData.ForeignKeysPreserved = true
	report.InitializedData.JSONPreserved = true
	report.InitializedData.SchemaSHA256 = hash
	report.InitializedData.MatchesAuthoritative = true
