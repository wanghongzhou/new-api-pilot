...
ORDER BY rule_key, level`).Scan(&rows).Error; err != nil {
	...
	expected := map[string]a85SeedEvidence{
		...
		"channel_availability_low/critical":   {"channel_availability_low", "critical", "channel.availability_rate", "<=", "0.8", 1},
		"channel_availability_low/warning":    {"channel_availability_low", "warning", "channel.availability_rate", "<=", "0.9", 3},
