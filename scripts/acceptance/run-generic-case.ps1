...
$goCases = @{
    ...
    A13 = @('./tests/contract ./tests/integration', '^(TestA13A40A64A82StatisticsAPIContract|TestA08A12A13A28CollectionHourReplacementAndVisibility)$')
    ...
    A63 = @('./tests/integration', '^(TestA63PerformanceHistoryAverageBoundaryAndWeightedCounters|TestA19A63ResourceSnapshotAcceptance)$')
    ...
    A76 = @('./router ./tests/contract', '^(TestUserAPIForcePasswordChangeAndSessionRotation|TestViewerCanReadButCannotWritePlatformUsers|TestLoginRateLimitReturnsRetryAfter|TestDisabledUserLoginReportsDisabledOnlyAfterPasswordVerification|TestPlatformUserAdminLifecycleOverHTTP|TestA76CRUDRouteAndDTOAcceptance)$')
    ...
    A86 = @('./tests/integration', '^(TestA04A06A07A10A24A36A37A56A57A86SiteAcceptance|TestA86DisabledRecheckStaysPausedWithoutBackfill)$')
    ...
    A102 = @('./tests/integration ./internal/docscheck', '^(TestA102ResourceGapRepairReopensWhenClosedRangeExpands|TestA102ResourceExpectedCoverageAndFinalize|TestA102RetentionExactBoundariesAndExclusions|TestA102SiteDeleteMaintenanceStatePolicy|TestA102AuthorizationPricingIntentIdempotencyFailureAndFence|TestExpectedDataMaintenanceContractsContainFiveOperations|TestDataMaintenanceCatalogDetectsMissingExtraAndTriggerDrift)$')
}
$e2eCases = @{
