...
func (request CustomerCreateRequest) Validate() map[string]string {
	return validateCustomerWrite(request.Name, request.Contact, request.Remark, request.Status)
}
...
func validateCustomerWrite(name, contact, remark, status string) map[string]string {
