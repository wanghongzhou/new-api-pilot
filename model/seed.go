...
var defaultSettings = []settingSeed{
	...
	{Key: "fast_task.history_retention_seconds", Value: "86400", Type: "int"},
	{Key: "fast_task.history_count", Value: "100", Type: "int"},
	{Key: "upstream.allowed_host_suffixes", Value: "", Type: "string"},
	{Key: "upstream.allowed_cidrs", Value: "", Type: "string"},
	{Key: "upstream.connect_timeout_seconds", Value: "5", Type: "int"},
	{Key: "upstream.response_header_timeout_seconds", Value: "15", Type: "int"},
	{Key: "upstream.request_timeout_seconds", Value: "30", Type: "int"},
	{Key: "upstream.export_timeout_seconds", Value: "120", Type: "int"},
	{Key: "upstream.rate_limit_requests", Value: "300", Type: "int"},
	{Key: "upstream.rate_limit_window_seconds", Value: "180", Type: "int"},
	{Key: "upstream.max_inflight_per_origin", Value: "4", Type: "int"},
	...
	{Key: "rate.fallback_quota_per_unit", Value: "500000", Type: "decimal"},
	{Key: "rate.fallback_usd_exchange_rate", Value: "6.8", Type: "decimal"},
...
var defaultAlertRules = []alertRuleSeed{
	...
	{Key: "account_quota_empty", Name: "Remote Account Balance Empty", Level: "warning", Metric: "account.quota", Operator: "<=", Threshold: "0", ForTimes: 1},
	...
	{Key: "channel_availability_low", Name: "Channel Availability Low", Level: "warning", Metric: "channel.availability_rate", Operator: "<=", Threshold: "0.90", ForTimes: 3},
	{Key: "channel_availability_low", Name: "Channel Availability Critical", Level: "critical", Metric: "channel.availability_rate", Operator: "<=", Threshold: "0.80", ForTimes: 1},
}
