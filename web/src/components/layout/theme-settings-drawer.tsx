      ...
      >
        {THEME_PRESETS.map((preset) => (
          <Item
            ...
            aria-label={presetLabels[preset.value]}
          >
            <div
              className={cn(
 ...
 * the currently active body font 鈥?that way the user sees what `Auto` will
 * actually look like for the active preset (Anthropic 鈫?serif glyphs,
 * everything else 鈫?sans glyphs) without us having to duplicate the
