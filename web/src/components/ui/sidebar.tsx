    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot='sidebar'
          data-mobile='true'
          className='bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 data-ending-style:invisible [&>button]:hidden'
          style={
            {
        ...
        >
          <SheetHeader className='sr-only'>
            <SheetTitle>{t('Primary navigation')}</SheetTitle>
            <SheetDescription>
              {t('Mobile navigation description')}
            </SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      <span className='sr-only'>
        {isMobile ? t('Open navigation') : t('Toggle Sidebar')}
      </span>
    </Button>
  )
}
